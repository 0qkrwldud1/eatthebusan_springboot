...
<!-- 게시판용 -->
<script type="text/javascript" src="${root}/static/jquery/jquery-3.4.1.js"></script>
<script type="text/javascript" src="${root}/static/datatables.min.js"></script>
<link rel="stylesheet" href="${root}/static/datatables.min.css">
<style type="text/css">
table {
	table-layout: fixed;
}
...
<link
	href="${root}/static/sb/vendor/fontawesome-free/css/all.min.css"
	rel="stylesheet" type="text/css">

<!-- Page level plugin CSS-->
<link
	href="${root}/static/sb/vendor/datatables/dataTables.bootstrap4.css"
	rel="stylesheet">

<!-- Custom styles for this template-->
<link href="${root}/static/sb/css/sb-admin.css" rel="stylesheet">
...
<body id="page-top">
	...
	<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
		...
		<a class="navbar-brand mr-1" href="${root}/admin/main.go">EatTheBusan 관리자페이지</a>			
		<!-- Navbar -->
